...
programa:  	tipo ':' TK_IDENTIFICADOR 
		...
		{$$ = astCreate(IKS_AST_FUNCAO, $3, $10, $13, NULL, NULL);stack_push(stack_pointer,$$);}	
...
parametros_funcao_c_param:
			tipo ':' TK_IDENTIFICADOR  {local_var=LocalVarListInsert(local_var,$3,type,0,function_list);
						    param_list =list_insert(param_list,type,func_id,$3->text);}

			| tipo ':'TK_IDENTIFICADOR {local_var=LocalVarListInsert(local_var,$3,type,0,function_list);
						    param_list =list_insert(param_list,type,func_id,$3->text);}	',' parametros_funcao_c_param 	
			;
